			...
			<div class="billing_details">
				<div class="row">
					<div class="col-lg-7">
						...
						<form class="row contact_form" action="<?= base_url('ecomerce/konfirmasi/').$id_user;?>" method="post">
						...
						<div class="col-md-6 mb-4">
                            ...
                            <input type="text" class="form-control" id="berat" name="berat" value="<?= $berat['berat']; ?>" placeholder="" readonly>
                        </div>
					</div>
					<div class="col-lg-5">
						<div class="order_box">
							...
							<div class="payment_item active">
								<div class="radion_btn mt-2">
									...
									<select class="form-control country_select" name="pembayaran" id="pembayaran">
