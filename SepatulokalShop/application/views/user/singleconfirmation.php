   ...
   <div class="d-flex align-items-center hot_deal_box">
	...
	<style type='text/css'>
		...
		<div class="container mt-5">
			...
			<div class="row order_d_inner">
				<div class="col-lg-4">
					<div class="details_item">
						...
						<ul class="list">
							<form class="row contact_form" action="<?= base_url('ecomerce/insertPesanan'); ?>" method="post" enctype="multipart/form-data">
							<li>
								<a href="#">
			...
			<input class="input1" type="text" name="idproduct" value="<?= $id ?>" readonly size="1" >
			<input class="input1" type="text" name="qty" value="<?= $quantity ?>" readonly size="1" >
			<input class="input1" type="text" name="alamat" value="<?= $alamat ?>" readonly size="1" >
			<input class="input1" type="text" name="desa" value="<?= $desa ?>" readonly size="1" >
			<input class="input1" type="text" name="kecamatan" value="<?= $kecamatan ?>" readonly size="1" ><div class="kabkot">
			...
			<input class="input1" type="text" name="total" value="<?= $total ?>" readonly size="1" >
			<input class="input1" type="text" name="harga" value="<?= $harga ?>" readonly size="1" >
