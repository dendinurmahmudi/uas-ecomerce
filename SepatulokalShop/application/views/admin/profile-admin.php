         ...
         <div class="cart_inner">
          <div class="col-md-6 mb-4">
			...
			<div class="billing_details">
              ...
              <a  class="main_btn" data-toggle="modal" data-target="#ubahrekening" id="btn-tambahUlasan" href="">Ubah No rekening</a>
              </div>
						</div>
					</div>
				</div>
...
<!--  -->
<form action="<?= base_url('admin/ubahnorek'); ?>" method="post">

	<div class="modal fade" id="ubahrekening" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalCenterTitle">Ubah No rekening</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body ">
          No rekening
          <div class="input-group mb-3">
            <input type="text" name="norekening" class="form-control" placeholder="No Rekening" aria-label="Username" aria-describedby="basic-addon1" required>
          </div>
          Atas Nama
          <div class="input-group mb-3">
            <input type="text" name="nama" class="form-control" placeholder="Atas Nama" aria-label="Username" aria-describedby="basic-addon1" required>
          </div>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
