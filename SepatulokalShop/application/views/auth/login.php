			...
			<div class="row hot_deals_area">
				...
				<div class="col-lg-6">
					<div class="login_form_inner">
						...
						<form class="row login_form" action="<?= base_url('auth'); ?>" method="post" id="contactForm" novalidate="novalidate">
							<div class="col-md-12 form-group">
							...
							<div class="col-md-12 form-group">
								...
								<a href="<?= base_url('auth/pendaftaran'); ?>">Belum punya akun? Buat akun.</a>
							</div>
						</form>
					</div>
				</div>
